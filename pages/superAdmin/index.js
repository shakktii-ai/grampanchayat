...
function Index() {
  return (
    ...
    <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
        ...
        <div class="px-4 text-gray-700">
            <h3 class="text-sm tracking-wider">एकूण ठराव</h3>
    ...
    <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
        ...
        <div class="px-4 text-gray-700">
            <h3 class="text-sm tracking-wider">एकूण तक्रार</h3>
    ...
    <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
        ...
        <div class="px-4 text-gray-700">
            <h3 class="text-sm tracking-wider">विकास कार्य</h3>
            <p class="text-3xl">34.12%</p>
        </div>
    </div>
</div>
<div class="h-full min-h-screen w-full pt-10 p-4">
  <div class="grid gap-14 md:grid-cols-3 md:gap-5">
    <div class="rounded-xl bg-white p-6 text-center shadow-xl">
      ...
      <Link href="/superAdmin/complaint" ><h1 class="text-darken mb-3 text-xl font-medium lg:px-14">तक्रार</h1></Link>
    ...
    <div data-aos-delay="150" class="rounded-xl bg-white p-6 text-center shadow-xl">
      ...
      <Link href="/superAdmin/tharavPost" ><h1 class="text-darken mb-3 text-xl font-medium lg:px-14 ">ठराव</h1></Link>
      <p class="px-4 text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo iure inventore amet
        modi
        accusantium vero perspiciatis, incidunt dicta sed aspernatur!</p>
    </div>
    <div data-aos-delay="300" class="rounded-xl bg-white p-6 text-center shadow-xl">
      ...
      <Link href="/superAdmin/developmentwork" ><h1 class="text-darken mb-3 pt-3 text-xl font-medium lg:h-14 lg:px-14">विकास कार्य</h1></Link>
      <p class="px-4 text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo iure inventore amet
        modi
        accusantium vero perspiciatis, incidunt dicta sed aspernatur!</p>
    </div>
...
<div class="h-full min-h-screen w-full -mt-20 p-4">
  <div class="grid gap-14 md:grid-cols-3 md:gap-5">
    <div class="rounded-xl bg-white p-6 text-center shadow-xl">
      <div
        class="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full bg-teal-400 shadow-lg shadow-teal-500/40">
      ...
      <h1 class="text-darken mb-3 text-xl font-medium lg:px-14">TREE </h1>
      <p class="px-4 text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo iure inventore amet
        modi
        accusantium vero perspiciatis, incidunt dicta sed aspernatur!</p>
    </div>
